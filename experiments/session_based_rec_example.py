...
def get_args():
    ...
    parser.add_argument('--dataset', '-d', type=str, default='diginetica', help='Benchmarks for session-based rec.')
...
if __name__ == '__main__':
    ...
    config = Config(model=args.model, dataset=f'{args.dataset}', config_dict=config_dict)   # all the configuration is in config.final_config_dict
    ...
    # dataset splitting
    train_dataset, _, test_dataset = dataset.build()
    if args.validation:
